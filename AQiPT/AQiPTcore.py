...
class function:
    ...
    def sawtooth(self, plotON=False):
        ...
        if plotON==True:
            ...
            return function, plt.plot(self.tbase, function)
    def sine4STIRAP(self, plotON=False):
        '''
            Sine function with a complete cycle
            ...
            \Example:
                ...
                args = {'amp':1, 'freq': 0}; #arguments for function
                'amp' is the amplitude of the sine pulse
                'freq' is the frequency of the sine pulse
        ...
        function =  0.5*(self.args['amp'] + self.args['amp']*np.sin(2*pi*self.args['freq']*self.tbase - np.pi/2))
